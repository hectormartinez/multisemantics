...
def main():
    ...
    parser.add_argument("--trainfile",   metavar="FILE", default="/Users/hector/Downloads/predictions_WSJ/conll2003english_ner/conll2003english_ner_test.conll.conll2003english_ner+pos.task0")
