...
def main():
    ...
    parser.add_argument("--doc", metavar="FILE",
                        default="/Users/hmartine/Downloads/database.mpqa.3.0/docs/20011024/21.53.09-11428")
    parser.add_argument("--annotations", metavar="FILE",
                        default="/Users/hmartine/Downloads/database.mpqa.3.0/man_anns/20011024/21.53.09-11428/gateman.mpqa.lre.3.0")
    ...
    if args.labels == 'coarse':
        for line in open(args.annotations).readlines():
            if line.startswith('#'):
                ...
                if label in ['direct-subjective', 'attitude', 'expressive-subjectivity',
                             'objective-speech-event'] and end > begin:  # we skip implicit
